...
private fun KineXApp() {
    ...
    // Hidden on the workout screen and nowhere else. That screen is a full-bleed camera
    // preview with its own control row along the bottom edge, and a navigation bar under it
    // would both cover the preview and sit directly beneath buttons it is not part of.
    val showBottomBar = !current.isOn(Workout::class)
    ...
    Scaffold(
        ...
        NavHost(navController = navController, startDestination = Home) {
            ...
            composable<Settings> { SettingsScreen(modifier = content) }
